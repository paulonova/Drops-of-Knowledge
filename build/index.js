...
class Search {
  ...
  getResult() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default().when(jquery__WEBPACK_IMPORTED_MODULE_0___default().getJSON(knowledgeData.root_url + '/wp-json/wp/v2/posts?search=' + this.searchField.val()), jquery__WEBPACK_IMPORTED_MODULE_0___default().getJSON(knowledgeData.root_url + '/wp-json/wp/v2/pages?search=' + this.searchField.val())).then((posts, pages) => {
      ...
      this.resultsDiv.html('<p>Unexpected error; please try again.</p> ' + ' Status: ' + e.statusText);
    });
  }
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = globalThis["webpackChunkdrops_of_knowledge_theme"] = globalThis["webpackChunkdrops_of_knowledge_theme"] || [];
